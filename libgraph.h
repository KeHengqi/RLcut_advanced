...
public:
	...
	int delete_zero = -1; // dealing with in-going degree and degree condition, by default is -1
public:
	...
	void setTestCharacter(int test_chara);
	int getTestCharacter();
	void setThreshold(int threshold);
	int getThreshold();
	void setDeleteZero(int delete_zero_or_not);
	int getDeleteZero();
};

// class Pthread_args_adv : public Pthread_args
// {
// public:
// 	// NOTE: percentage for the ratio of selected point
// 	double percentage;
// 	int test_character;
// 	int threshold_number;
// public:
